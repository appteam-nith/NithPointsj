 ...
 *
 * <a href="http://www.NithPoints.org/smf/index.php?topic=3638.0">http://www.NithPoints.org/smf/index.php?topic=3638
 * .0</a><p>
 *
...
public class PrivateKeys {
    public static void main(String[] args) throws Exception {
        ...
        try {
            // Decode the private key from Satoshis Base58 variant. If 51 characters long then it's from NithPointss
            ...
            // And take them!
            System.out.println("Claiming " + Utils.NithPointsValueToFriendlyString(wallet.getBalance()) + " coins");
