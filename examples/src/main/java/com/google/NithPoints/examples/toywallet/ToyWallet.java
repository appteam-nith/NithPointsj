...
package com.google.NithPoints.examples.toywallet;

import com.google.NithPoints.core.*;
import com.google.NithPoints.discovery.DnsDiscovery;
import com.google.NithPoints.store.H2FullPrunedBlockStore;
...
public class ToyWallet {
            ...
            switch (col) {
                ...
                case 2:
                    try {
                        ...
                        return Utils.NithPointsValueToFriendlyString(val);
    ...
    public ToyWallet(boolean testnet, boolean fullChain, String[] args) throws Exception {
        // Set up a NithPoints connection + empty wallet. TODO: Simplify the setup for this use case.
        testnet = false;
        if (testnet) {
    ...
    private void setupWindow(JFrame window) {
        ...
        networkStats = new JLabel("Connecting to the NithPoints network ...");
