...
package com.google.NithPoints.examples;

import com.google.NithPoints.core.*;
import com.google.NithPoints.crypto.KeyCrypterException;
import com.google.NithPoints.discovery.DnsDiscovery;
import com.google.NithPoints.store.BlockStore;
import com.google.NithPoints.store.SPVBlockStore;
 ...
 * <li>Start your NithPoints client in test mode <code>NithPoints -testnet</code>. This will create a new sub-directory called testnet and should not interfere with normal wallets or operations.</li>
 * <li>(Optional) Choose a fresh address</li>
 * <li>(Optional) Visit the Testnet faucet (https://testnet.freeNithPointss.appspot.com/) to load your client with test coins</li>
 * <li>Run <code>PingService testnet</code></li>
 * <li>Wait for the block chain to download</li>
 * <li>Send some coins from your NithPoints client to the address provided in the PingService console</li>
 ...
 * .net/projects/NithPoints/files/NithPoints/testnet-in-a-box/">testnet in a box</a> to do everything purely locally.</p>
 */
public class PingService {
    ...
    public PingService(String[] args) throws Exception {
        ...
        wallet.addEventListener(new AbstractWalletEventListener() {
            ...
            public void onCoinsReceived(Wallet w, Transaction tx, BigInteger prevBalance, BigInteger newBalance) {
                ...
                System.out.println("Received pending tx for " + Utils.NithPointsValueToFriendlyString(value) +
                        ": " + tx);
    ...
    private void bounceCoins(final Wallet wallet, Transaction tx) {
        // It's impossible to pick one specific identity that you receive coins from in NithPoints as there
        ...
        try {
            ...
            System.out.println("Received " + Utils.NithPointsValueToFriendlyString(value) + " from " + from.toString());
