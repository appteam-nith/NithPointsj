...
public class ChainSplitTest {
    ...
    public void testForking1() throws Exception {
        ...
        assertEquals("100.00", Utils.NithPointsValueToFriendlyString(wallet.getBalance()));
        ...
        assertEquals("50.00", Utils.NithPointsValueToFriendlyString(wallet.getBalance()));
        ...
        assertEquals("200.00", Utils.NithPointsValueToFriendlyString(wallet.getBalance()));
    }
    ...
    public void txConfidenceLevels() throws Exception {
        ...
        assertEquals("250.00", Utils.NithPointsValueToFriendlyString(wallet.getBalance()));
