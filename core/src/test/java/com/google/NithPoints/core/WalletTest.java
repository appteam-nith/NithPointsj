...
import com.google.NithPoints.core.Transaction.SigHash;
...
import com.google.NithPoints.store.MemoryBlockStore;
import com.google.NithPoints.utils.BriefLogFormatter;
import com.google.common.collect.Lists;
import com.google.protobuf.ByteString;

import org.NithPointsj.wallet.Protos;
import org.NithPointsj.wallet.Protos.ScryptParameters;
...
import static com.google.NithPoints.core.TestUtils.*;
import static com.google.NithPoints.core.TestUtils.createFakeBlock;
import static com.google.NithPoints.core.TestUtils.createFakeTx;
import static com.google.NithPoints.core.Utils.NithPointsValueToFriendlyString;
import static com.google.NithPoints.core.Utils.toNanoCoins;
...
public class WalletTest {
    ...
    private void basicSpendingCommon(Wallet wallet, Address toAddress, boolean testEncryption) throws Exception {
        ...
        // will attach a small fee. Because the NithPoints protocol makes it difficult to determine the fee of an
    ...
    public void blockChainCatchup() throws Exception {
        ...
        assertEquals(NithPointsValueToFriendlyString(wallet.getBalance()), "0.90");
        assertEquals(null, txn[0]);
        assertEquals(2, confTxns.size());
        assertEquals(txn[1].getHash(), send1.getHash());
        assertEquals(NithPointsValueToFriendlyString(bigints[2]), "1.00");
        assertEquals(NithPointsValueToFriendlyString(bigints[3]), "0.90");
        ...
        assertEquals(NithPointsValueToFriendlyString(wallet.getBalance()), "0.80");
    ...
    public void balances() throws Exception {
        ...
        Transaction send1 = wallet.createSend(new ECKey().toAddress(params), toNanoCoins(0, 10));
        // Reserialize.
        Transaction send2 = new Transaction(params, send1.NithPointsSerialize());
    ...
    public void isConsistent_duplicates() throws Exception {
        ...
        Transaction txClone = new Transaction(params, tx.NithPointsSerialize());
        try {
    ...
    public void doubleSpendUnspendsOtherInputs() throws Exception {
        ...
        send2 = new Transaction(params, send2.NithPointsSerialize());
    ...
    public void pending1() throws Exception {
        ...
        final Transaction t1Copy = new Transaction(params, t1.NithPointsSerialize());
    ...
    public void spendToSameWallet() throws Exception {
        ...
        assertEquals(BigInteger.ZERO, wallet.getBalance());
        sendMoneyToWallet(outbound1, AbstractBlockChain.NewBlockType.BEST_CHAIN);
        // We should have a balance of 1 PTS after the block is received.
        assertEquals(coin1, wallet.getBalance());
    }
    ...
    public void autosaveImmediate() throws Exception {
        ...
        File f = File.createTempFile("NithPointsj-unit-test", null);
