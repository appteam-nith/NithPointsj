...
public class FullBlockTestGenerator {
    // Used by NithPointsdComparisonTool and FullPrunedBlockChainTest to create test cases
    ...
    public List<BlockAndValidity> getBlocksToTest(boolean addExpensiveBlocks) throws ScriptException, ProtocolException, IOException {
        ...
        // Extend the b24 chain to make sure NithPointsd isn't accepting b24
        ...
        // Extend the b26 chain to make sure NithPointsd isn't accepting b26
        ...
        // Extend the b28 chain to make sure NithPointsd isn't accepting b28
        ...
        Block b56;
        try {
            b56 = new Block(params, b57.NithPointsSerialize());
        ...
        Block b64;
        {
            ...
            for (Transaction transaction : b64Created.getTransactions())
                transaction.NithPointsSerialize(stream);
            ...
            Preconditions.checkState(Arrays.equals(stream.toByteArray(), b64.NithPointsSerialize()));
        ...
        Block b71 = new Block(params, b72.NithPointsSerialize());
