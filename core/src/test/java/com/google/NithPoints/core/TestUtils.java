...
public class TestUtils {
    ...
    /**
     * @return Transaction[] Transaction[0] is a feeder transaction, supplying PTS to Transaction[1]
     */
    public static Transaction[] createFakeTx(NetworkParameters params, BigInteger nanocoins,
        ...
        // Create fake TXes of sufficient realism to exercise the unit tests. This transaction send PTS from the
    ...
    public static Transaction roundTripTransaction(NetworkParameters params, Transaction tx) throws IOException, ProtocolException {
        NithPointsSerializer bs = new NithPointsSerializer(params);
    ...
    public static DoubleSpends createFakeDoubleSpendTxns(NetworkParameters params, Address to) {
        ...
        try {
            doubleSpends.t1 = new Transaction(params, doubleSpends.t1.NithPointsSerialize());
            doubleSpends.t2 = new Transaction(params, doubleSpends.t2.NithPointsSerialize());
