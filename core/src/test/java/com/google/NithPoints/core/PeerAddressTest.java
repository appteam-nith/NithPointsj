...
public class PeerAddressTest
{
    ...
    public void testPeerAddressRoundtrip() throws Exception {
        // copied verbatim from https://en.NithPoints.it/wiki/Protocol_specification#Network_address
        ...
        String reserialized = Utils.bytesToHexString(pa.NithPointsSerialize());
        assertEquals(reserialized,fromSpec );
    }

    @Test
    public void testNithPointsSerialize() throws Exception {
        ...
        assertEquals("000000000000000000000000000000000000ffff7f000001208d",
                Utils.bytesToHexString(pa.NithPointsSerialize()));
    }
}
