...
import com.google.NithPoints.core.StoredBlock;
 ...
 *
 * A BlockStore is a map of hashes to StoredBlock. The hash is the double digest of the NithPoints serialization
...
public interface BlockStore {
     ...
     * can be arbitrarily expensive, you probably should use {@link com.google.NithPoints.core.BlockChain#getChainHead()}
     * or perhaps {@link com.google.NithPoints.core.BlockChain#getBestChainHeight()} which will run in constant time and
