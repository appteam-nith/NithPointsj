...
import com.google.NithPoints.core.StoredTransactionOutput;
import com.google.NithPoints.core.StoredUndoableBlock;
 ...
 * NithPoints serialization of the block header, <b>not</b> the header with the extra data as well.</p>
 * 
 * <p>A FullPrunedBlockStore also contains a map of hash+index to StoredTransactionOutput.  Again, the hash is
 * a standard NithPoints double-SHA256 hash of the transaction.</p>
 *
