 ...
 */
package com.google.NithPoints.crypto;
...
public interface KeyCrypter extends Serializable {
     ...
     */
    byte[] decrypt(EncryptedPrivateKey encryptedBytesToDecode, KeyParameter aesKey) throws KeyCrypterException;
     ...
     */
    EncryptedPrivateKey encrypt(byte[] plainBytes, KeyParameter aesKey) throws KeyCrypterException;
}
