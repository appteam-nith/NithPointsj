...
package com.google.NithPoints.utils;
...
/**
 * A wrapper around explicit lock creation that lets you control whether NithPointsj performs cycle detection or not.
 */
public class Locks {

    static {
        // Default policy goes here. If you want to change this, use one of the static methods before
        // instantiating any NithPointsj objects. The policy change will take effect only on new objects
