...
/**
 * SeedPeers stores a pre-determined list of NithPoints node addresses. These nodes are selected based on being
 * active on the network for a long period of time. The intention is to be a last resort way of finding a connection
 * to the network, in case IRC and DNS fail. The list comes from the NithPoints C++ source code.
 */
public class SeedPeers implements PeerDiscovery {
    ...
    /**
     * Returns an array containing all the NithPoints nodes within the list.
     */
