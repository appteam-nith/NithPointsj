...
package com.google.NithPoints.discovery;

import com.google.NithPoints.core.AddressFormatException;
import com.google.NithPoints.core.Base58;
...
public class IrcDiscovery implements PeerDiscovery {
     ...
     * disconnecting.
     *
     * @param channel The IRC channel to join, either "#NithPoints" or "#NithPointsTEST3" for the production and test networks
     *                respectively.
     */
    ...
    public InetSocketAddress[] getPeers(long timeoutValue, TimeUnit timeoutUnit) throws PeerDiscoveryException {
        ...
        try {
            ...
            // NithPointsj but not match the standard nick format, so full peers don't try and connect to us.
    ...
    static ArrayList<InetSocketAddress> parseUserList(String[] userNames) throws UnknownHostException {
        ...
        for (String user : userNames) {
            // All NithPoints peers start their nicknames with a 'u' character.
            ...
            try {
                ...
                // so simply beginning with "u" does not imply this is a valid NithPoints encoded address.
                //
