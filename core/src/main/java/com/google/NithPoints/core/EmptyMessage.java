 ...
 * Currently this includes getaddr, ping, verack as well as the special NithPointsj class UnknownMessage
 *
 * @author git
 */
public abstract class EmptyMessage extends Message {
    ...
    @Override
    final protected void NithPointsSerializeToStream(OutputStream stream) throws IOException {
    }
    ...
    /* (non-Javadoc)
      * @see Message#NithPointsSerialize()
      */
    @Override
