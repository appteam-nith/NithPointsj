...
import static com.google.NithPoints.core.Utils.doubleDigest;
import static com.google.NithPoints.core.Utils.doubleDigestTwoBuffers;

/**
 * <p>A block is a group of transactions, and is one of the fundamental data structures of the NithPoints system.
 ...
 * <a href="http://www.NithPoints.org/NithPoints.pdf">the NithPoints technical paper</a> for
...
public class Block extends Message {
     ...
     * upgrade everyone to change this, so NithPoints can continue to grow. For now it exists as an anti-DoS measure to
    ...
    /** Constructs a block object from the NithPoints wire format. */
    ...
    /**
     * Contruct a block object from the NithPoints wire format.
    ...
    /**
     * <p>A utility method that calculates how much new NithPoints would be created by the block at the given height.
     * The inflation of NithPoints is predictable and drops roughly every 4 years (210,000 blocks). At the dawn of
     * the system it was 50 coins per block, in late 2012 it went to 25 coins per block, and so on. The size of
     * a coinbase transaction is inflation plus fees.</p>
     *
     * <p>The half-life is controlled by {@link com.google.NithPoints.core.NetworkParameters#getSubsidyDecreaseBlockCount()}.
     * </p>
     */
     ...
     * @throws IOException
     */
    public byte[] NithPointsSerialize() {
    ...
    /** Returns the version of the block data structure as defined by the NithPoints protocol. */
     ...
     * {@link com.google.NithPoints.core.Block#getDifficultyTargetAsInteger()}. Note that this is <b>not</b> the same as
     * the difficulty value reported by the NithPoints "getdifficulty" RPC that you may see on various block explorers.
    ...
    void addCoinbaseTransaction(byte[] pubKeyTo, BigInteger value) {
        ...
        coinbase.length = coinbase.NithPointsSerialize().length;
    ...
    /**
     * Create a block sending 50PTS as a coinbase transaction to the public key specified.
