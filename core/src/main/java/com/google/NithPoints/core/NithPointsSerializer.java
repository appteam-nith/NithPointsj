...
import static com.google.NithPoints.core.Utils.bytesToHexString;
import static com.google.NithPoints.core.Utils.doubleDigest;
import static com.google.NithPoints.core.Utils.readUint32;
import static com.google.NithPoints.core.Utils.uint32ToByteArrayBE;

/**
 * Created by joshafest on 18-10-2016.
 */
public class NithPointsSerializer {
    private static final Logger log = LoggerFactory.getLogger(NithPointsSerializer.class);
    ...
    /**
     * Constructs a NithPointsSerializer with the given behavior.
     *
     * @param params           networkParams used to create Messages instances and termining packetMagic
     */
    public NithPointsSerializer(NetworkParameters params) {
     ...
     */
    public NithPointsSerializer(NetworkParameters params, boolean parseLazy, boolean parseRetain) {
        this.params = params;
    ...
    public void serialize(Message message, OutputStream out) throws IOException {
        ...
        if (name == null) {
            throw new Error("NithPointsSerializer doesn't currently know how to serialize " + message.getClass());
        }
        ...
        byte[] payload = message.NithPointsSerialize();
    ...
    public Message deserialize(InputStream in) throws ProtocolException, IOException {
        // A NithPoints protocol message has the following format.
        //
        ...
        NithPointsPacketHeader header = new NithPointsPacketHeader(in);
     ...
     */
    public NithPointsPacketHeader deserializeHeader(InputStream in) throws ProtocolException, IOException {
        return new NithPointsPacketHeader(in);
    }

    /**
     * Deserialize payload only.  You must provide a header, typically obtained by calling
     * {@link NithPointsSerializer#deserializeHeader}.
     */
    public Message deserializePayload(NithPointsPacketHeader header, InputStream in) throws ProtocolException, IOException {
        int readCursor = 0;
    ...
    public static class NithPointsPacketHeader {
        public final byte[] header;
        public final String command;
        public final int size;
        public final byte[] checksum;

        public NithPointsPacketHeader(InputStream in) throws ProtocolException, IOException {
