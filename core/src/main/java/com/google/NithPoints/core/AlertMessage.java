 ...
 * The private keys are held by a small group of core NithPoints developers, and alerts may be broadcast in the event of
...
public class AlertMessage extends Message {
    ...
    void parse() throws ProtocolException {
        ...
        version = readUint32();
        // Read the timestamps. NithPoints uses seconds since the epoch.
