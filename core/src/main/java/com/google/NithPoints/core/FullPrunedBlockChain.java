 ...
 * NithPoints system, with the downside being a larg cost in system resources. Fully verifying means all unspent transaction
    ...
    protected TransactionOutputChanges connectTransactions(int height, Block block)
        ...
        try {
            if (!params.isCheckpoint(height)) {
                ...
                // BIP30 document for more details on this: https://en.NithPoints.it/wiki/BIP_0030
            ...
            for (final Transaction tx : block.transactions) {
                ...
                if (valueOut.compareTo(BigInteger.ZERO) < 0 || valueOut.compareTo(NetworkParameters.MAX_MONEY) > 0)
