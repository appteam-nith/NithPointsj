...
/**
 * <p>A BlockChain implements the <i>simplified payment verification</i> mode of the NithPoints protocol. It is the right
...
public class BlockChain extends AbstractBlockChain {
     ...
     * </p>
     *
     * <p>For the store, you should use {@link com.google.NithPoints.store.SPVBlockStore} or you could also try a
     * {@link com.google.NithPoints.store.MemoryBlockStore} if you want to hold all headers in RAM and don't care about
