...
/**
 * <p>A {@code TCPNetworkConnection} is used for connecting to a NithPoints node over the standard TCP/IP protocol.<p>
 *
...
public class TCPNetworkConnection implements NetworkConnection {
    ...
    private NithPointsSerializer serializer = null;
    ...
    public TCPNetworkConnection(NetworkParameters params, VersionMessage ver) {
        ...
        this.serializer = new NithPointsSerializer(this.params);
    ...
    private void onVersionMessage(Message m) throws IOException, ProtocolException {
        ...
        // NithPointsj is a client mode implementation. That means there's not much point in us talking to other client
    ...
    public class NetworkHandler extends ReplayingDecoder<VoidEnum> implements ChannelDownstreamHandler {
        ...
        // Attempt to decode a NithPoints message passing upstream in the channel.
        //
    ...
    /** Returns the Netty Pipeline stage handling NithPoints serialization for this connection. */
