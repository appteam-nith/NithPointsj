...
import static com.google.NithPoints.core.Utils.COIN;
import static com.google.common.base.Preconditions.checkState;

/**
 * <p>NetworkParameters contains the data needed for working with an instantiation of a NithPoints chain.</p>
 *
 * <p></p>Currently there are only two, the production chain and the test chain. There is also a "unit test chain" which
 * is internal to NithPointsj and can't be used on a real network. In future there may be others. </p>
 */
public class NetworkParameters implements Serializable {
    ...
    public static final String ID_PRODNET = "org.NithPoints.production";
    /** The string returned by getId() for the testnet. */
    public static final String ID_TESTNET = "org.NithPoints.test";
    /** Unit test network. */
    static final String ID_UNITTESTNET = "com.google.NithPoints.unittest";
     ...
     *
     * <p>The first block in every chain is a well known constant shared between all NithPoints implemenetations. For a
    ...
    /** How many blocks pass between difficulty adjustment periods. NithPoints standardises this to be 2015. */
    public /*final*/ int interval;
    /**
     * How much time in seconds is supposed to pass between "interval" blocks. If the actual elapsed time is
     * significantly different from this value, the network difficulty formula will produce a different value. Both
     * test and production NithPoints networks use 2 weeks (1209600 seconds).
     */
    ...
    private NetworkParameters(int type) {
        ...
        if (type == 0) {
           ...
           /* checkpoints.put(91722, new Sha256Hash("00000000000271a2dc26e7667f8419f2e15416dc6955e5a6c6cdf3f2574dd08e"));
            ...
            dnsSeeds = new String[] {
                    "testnet-seed.NithPoints.petertodd.org",
    ...
    public static final int TARGET_SPACING = 30;  // 10 minutes per block.
    ...
    /** The primary NithPoints chain created by Satoshi. */
