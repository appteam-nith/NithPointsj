...
import com.google.NithPoints.crypto.KeyCrypterScrypt;
import org.NithPointsj.wallet.Protos.Wallet.EncryptionType;
import org.spongycastle.crypto.params.KeyParameter;

import com.google.NithPoints.core.TransactionConfidence.ConfidenceType;
import com.google.NithPoints.core.WalletTransaction.Pool;
import com.google.NithPoints.crypto.KeyCrypter;
import com.google.NithPoints.crypto.KeyCrypterException;
import com.google.NithPoints.store.WalletProtobufSerializer;
...
import static com.google.NithPoints.core.Utils.NithPointsValueToFriendlyString;
 ...
 * of the NithPoints protocol.</p>
 *
 * <p>To learn more about this class, read <b><a href="http://code.google.com/p/NithPointsj/wiki/WorkingWithTheWallet">
 ...
 * other objects, see the <a href="http://code.google.com/p/NithPointsj/wiki/GettingStarted">Getting started</a> tutorial
 * on the website to learn more about how to set everything up.</p>
 *
 * <p>Wallets can be serialized using either Java serialization - this is not compatible across versions of NithPointsj,
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.google.NithPoints.core.Wallet.AutosaveEventListener)}
...
public class Wallet implements Serializable, BlockChainListener {
     ...
     * that handles this in NithPoints C++ is complicated. Satoshis code will not allow you to spend unconfirmed coins,
    ...
    public interface AutosaveEventListener {
         ...
         */
        boolean caughtException(Throwable t);
    ...
    public void receivePending(Transaction tx, List<Transaction> dependencies) throws VerificationException {
        ...
        try {
            ...
            if (log.isInfoEnabled()) {
                log.info(String.format("Received a pending transaction %s that spends %s PTS from our own wallet," +
                        " and sends us %s PTS", tx.getHashAsString(), Utils.NithPointsValueToFriendlyString(valueSentFromMe),
                        Utils.NithPointsValueToFriendlyString(valueSentToMe)));
            }
    ...
    private void receive(Transaction tx, StoredBlock block, BlockChain.NewBlockType blockType, boolean reorg) throws VerificationException {
        ...
        if (!reorg) {
            log.info("Received tx {} for {} PTS: {}", new Object[]{sideChain ? "on a side chain" : "",
                    NithPointsValueToFriendlyString(valueDifference), tx.getHashAsString()});
        }
        ...
        log.info("Balance is now: " + NithPointsValueToFriendlyString(newBalance));
    ...
    public static class SendResult {
        /** The NithPoints transaction message that moves the money. */
    ...
    public static class SendRequest {
         ...
         * is how mining is incentivized in later years of the NithPoints system when inflation drops. It also provides
         * a way for people to prioritize their transactions over others and is used as a way to make denial of service
         * attacks expensive. Some transactions require a fee due to their structure - currently NithPointsj does not
     ...
     * followed by {@link Wallet#completeTx(com.google.NithPoints.core.Wallet.SendRequest)} and returning the requests
     ...
     *
     * @param address       The NithPoints address to send the money to.
     ...
     * {@link Wallet#completeTx(com.google.NithPoints.core.Wallet.SendRequest)} to make it valid.
     *
    ...
    public boolean completeTx(SendRequest req) {
        ...
        try {
            ...
            log.info("Completing send tx with {} outputs totalling {}",
                    req.tx.getOutputs().size(), NithPointsValueToFriendlyString(value));
            ...
            if (selection.valueGathered.compareTo(value) < 0) {
                log.warn("Insufficient value in wallet for send, missing " +
                        NithPointsValueToFriendlyString(value.subtract(selection.valueGathered)));
            ...
            if (change.compareTo(BigInteger.ZERO) > 0) {
                ...
                log.info("  with {} coins change", NithPointsValueToFriendlyString(change));
            ...
            // Check size.
            int size = req.tx.NithPointsSerialize().length;
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.google.NithPoints.core.Wallet.AutosaveEventListener)}
    ...
    public String toString(boolean includePrivateKeys, AbstractBlockChain chain) {
        ...
        try {
            ...
            builder.append(String.format("Wallet containing %s PTS in:%n", NithPointsValueToFriendlyString(getBalance())));
    ...
    private void toStringHelper(StringBuilder builder, Map<Sha256Hash, Transaction> transactionMap,
        ...
        for (Transaction tx : transactionMap.values()) {
            try {
                ...
                builder.append(Utils.NithPointsValueToFriendlyString(tx.getValueSentFromMe(this)));
                builder.append(" and receives ");
                builder.append(Utils.NithPointsValueToFriendlyString(tx.getValueSentToMe(this)));
                builder.append(", total value ");
                builder.append(Utils.NithPointsValueToFriendlyString(tx.getValue(this)));
                builder.append(".\n");
            } catch (ScriptException e) {
    ...
    public void reorganize(StoredBlock splitPoint, List<StoredBlock> oldBlocks, List<StoredBlock> newBlocks) throws VerificationException {
        ...
        try {
            ...
            log.info("post-reorg balance is {}", Utils.NithPointsValueToFriendlyString(getBalance()));
     ...
     * {@link com.google.NithPoints.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(com.google.NithPoints.crypto.KeyCrypter,
     ...
     * {@link com.google.NithPoints.crypto.KeyCrypterScrypt}.
     *
        ...
        try {
            ...
            for (ECKey key : keychain) {
                if (key.isEncrypted()) {
                    ...
                    // (all NithPoints controlled by that private key is lost forever).
    ...
    /**
     * <p>Convenience wrapper around {@link Wallet#addNewEncryptedKey(com.google.NithPoints.crypto.KeyCrypter,
            ...
            for (int i = 0; i < tx.getOutputs().size(); i++) {
                ...
                try {
                    if (out.isMine(this) && out.getScriptPubKey().isSentToRawPubKey()) {
                        ...
                        filter.insert(outPoint.NithPointsSerialize());
                    }
                } catch (ScriptException e) {
                    throw new RuntimeException(e); // If it is ours, we parsed the script corectly, so this shouldn't happen
                }
