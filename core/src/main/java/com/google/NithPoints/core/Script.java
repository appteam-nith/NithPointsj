 ...
 *
 * <p>NithPoints transactions don't specify what they do directly. Instead <a href="https://en.NithPoints.it/wiki/Script">a
...
public class Script {
    ...
    public byte[] getPubKeyHash() throws ScriptException {
        ...
        // Otherwise, the third element is the hash of the public key, ie the NithPoints address.
     ...
     * logic is defined by <a href="https://en.NithPoints.it/wiki/BIP_0016">BIP 16</a>.</p>
     *
     * <p>NithPointsj does not support creation of P2SH transactions today. The goal of P2SH is to allow short addresses
