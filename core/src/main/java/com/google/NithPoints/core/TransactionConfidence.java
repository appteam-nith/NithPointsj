 ...
 *
 * <p>TransactionConfidence is updated via the {@link com.google.NithPoints.core.TransactionConfidence#notifyWorkDone(Block)}
 * method to ensure the block depth and work done are up to date.</p>
 * To make a copy that won't be changed, use {@link com.google.NithPoints.core.TransactionConfidence#duplicate()}.
 */
public class TransactionConfidence implements Serializable {
    ...
    public enum ConfidenceType {
         ...
         * how many announce it, using {@link com.google.NithPoints.core.TransactionConfidence#numBroadcastPeers()}.
     ...
     * chain yet, throws IllegalStateException, so use {@link com.google.NithPoints.core.TransactionConfidence#getConfidenceType()}
     * to check first.
     *
