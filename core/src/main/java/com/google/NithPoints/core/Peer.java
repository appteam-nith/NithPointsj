...
/**
 * A Peer handles the high level communication with a NithPoints node.
 *
 * <p>{@link Peer#getHandler()} is part of a Netty Pipeline with a NithPoints serializer downstream of it.
 */
public class Peer {
    ...
    private static class GetDataRequest {
        ...
        // a nasty hack that relies on the fact that NithPoints-qt is single threaded and processes messages in order.
    ...
    class PeerHandler extends SimpleChannelHandler {
        ...
        /** Handle incoming NithPoints messages */
        @Override
    ...
    /** Returns the Netty Pipeline stage handling the high level NithPoints protocol. */
    ...
    private void blockChainDownload(Sha256Hash toHash) throws IOException {
        ...
        try {
            ...
            //
            //   https://en.NithPoints.it/wiki/Protocol_specification#getblocks
            //
     ...
     * Once the pong is received the value returned by {@link com.google.NithPoints.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link com.google.NithPoints.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link com.google.NithPoints.core.Peer#ping()} has never
