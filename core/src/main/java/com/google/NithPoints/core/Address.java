...
/**
 * <p>A NithPoints address looks like 1MsScoe2fTJoq4ZPdQgqyhgWeoNamYPevy and is derived from an elliptic curve public key
...
public class Address extends VersionedChecksummedBytes {
    ...
    /** The (big endian) 20 byte hash that is the core of a NithPoints address. */
