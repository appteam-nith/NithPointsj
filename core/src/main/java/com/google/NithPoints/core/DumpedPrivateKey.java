...
/**
 * Parses and generates private keys in the form used by the NithPoints "dumpprivkey" command. This is the private key
...
public class DumpedPrivateKey extends VersionedChecksummedBytes {
    ...
    /**
     * Parses the given private key as created by the "dumpprivkey" NithPoints C++ RPC.
     *
