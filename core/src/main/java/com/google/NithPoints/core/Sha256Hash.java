...
public class Sha256Hash implements Serializable {
    ...
    /**
     * Calculates the hash of the hash of the contents. This is a standard operation in NithPoints.
     */
    ...
    @Override
    public int hashCode() {
        // Use the last 4 bytes, not the first 4 which are often zeros in NithPoints.
