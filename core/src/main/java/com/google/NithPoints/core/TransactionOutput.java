...
public class TransactionOutput extends ChildMessage implements Serializable {
    ...
    // These fields are Java serialized but not NithPoints serialized. They are used for tracking purposes in our wallet
    ...
    */
    ...
    public String toString() {
        try {
            return "TxOut of " + Utils.NithPointsValueToFriendlyString(value) + " to " + getScriptPubKey().getToAddress()
