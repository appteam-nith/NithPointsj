...
public class VersionMessage extends Message {
    ...
    public static final String NithPointsJ_VERSION = "0.8";
    /** The value that is prepended to the subVer field of this application. */
    public static final String LIBRARY_SUBVER = "/NithPointsJ:" + NithPointsJ_VERSION + "/";
    ...
    @Override
    public void NithPointsSerializeToStream(OutputStream buf) throws IOException {
        ...
        try {
            // My address.
            myAddr.NithPointsSerialize(buf);
            // Their address.
            theirAddr.NithPointsSerialize(buf);
        } catch (UnknownHostException e) {
     ...
     * name:version pairs separated by slashes in the form of a path. For example a typical subVer field for NithPointsJ
     * users might look like "/NithPointsJ:0.4-SNAPSHOT/MultiBit:1.2/" where libraries come further to the left.<p>
     *
     ...
     * set of "/NithPointsJ:1.0/MultiBit:1.0(Windows)/. Therefore the / ( and ) characters are reserved in all these
     * components. If you don't want to add a comment (recommended), pass null.<p>
     *
     * See <a href="https://en.NithPoints.it/wiki/BIP_0014">BIP 14</a> for more information.
     *
