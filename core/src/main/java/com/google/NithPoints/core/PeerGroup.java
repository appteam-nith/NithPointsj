...
import com.google.NithPoints.core.Peer.PeerHandler;
import com.google.NithPoints.discovery.PeerDiscovery;
import com.google.NithPoints.discovery.PeerDiscoveryException;
...
public class PeerGroup extends AbstractIdleService {
    ...
    // pipeline with the NithPoints serializer ({@code TCPNetworkConnection}) downstream
     ...
     * <a href="https://en.NithPoints.it/wiki/BIP_0014">BIP 14</a>.
     *
     ...
     * peers. By using this with {@link com.google.NithPoints.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link com.google.NithPoints.core.PeerGroup#getMaxConnections()} returns is used.
     * @return
     */
    ...
    /**
     * See {@link com.google.NithPoints.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * times are available via {@link com.google.NithPoints.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link com.google.NithPoints.core.Peer#ping()}.
     */
